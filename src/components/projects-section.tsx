                ...
                return (
                  <div key={project.id}>
                    ...
                    <Card
                      ...
                      className="w-full max-w-md mx-auto bg-sky-100 dark:bg-slate-800 border border-sky-200 dark:border-slate-700 overflow-hidden hover:shadow-xl transition-all duration-300 project-card cursor-pointer"
                    >
                      ...
                      <CardContent className="p-6">
                        ...
                        <p className="text-black text-white mb-4 text-sm leading-relaxed">{project.description}</p>
